...
name: juexing-skill
description: |
  自我觉醒.skill —— 读你自己的聊天记录，但只读你说过的话（别人的一个字都不进来），
  先在本地把可数的东西数成数字，再用一百位心理学家、哲学家、教育家的视角照一遍，
  产出一份带证据、可反驳、会自己攻击自己的自述报告：你在哪个人生阶段、你是什么时候变的、
  接下来九十天做哪三件事。支持微信、iMessage、Telegram、WhatsApp，以及你写过的任何文字。
